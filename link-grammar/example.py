...
from linkgrammar import Sentence, ParseOptions, Dictionary, Clinkgrammar as linkgrammar.Clinkgrammar

print ("Version:", linkgrammar.Clinkgrammar.linkgrammar_get_version())
