...
text_clf_MultiNB = Pipeline([('vect', CountVectorizer()), ('tfidf', TfidfTransformer()), ('clf-MultiNB', MultinomialNB())])

# Define optimization parameters:
parameters = {'vect__stop_words': ['english', None],'vect__ngram_range': [(1, 1), (1, 2)],
'tfidf__norm':['l1', 'l2'], 'tfidf__use_idf': (True, False),
'clf-MultiNB__alpha': (1e-2, 1e-3),'clf-MultiNB__fit_prior':[True, False]}

# Conduct GridSearch:
gs_clf = GridSearchCV(text_clf_MultiNB, parameters, n_jobs=-1)
